...
document.addEventListener('DOMContentLoaded', () => {
  ...
  $('loginForm').addEventListener('submit', (e) => {
    ...
    if (email === 'user' && password === 'user') {
      ...
      btn.disabled = true;
      setTimeout(() => {
        window.location.href = '../Employee System/index.html';
      }, 900);
      return;
    }
    // =================================
  ...
  $('ownerExportData').addEventListener('click', () => {
    const data = { products, offers, galleryImages, contentOverrides, mixWeights, mixPackaging, candyTypes, deliveryZones, storeHours, employees: loadEmployees() };
